...
const CATEGORIES: CategorySeed[] = [
  {
    ...
    products: [
      ...
      // Sprouts (session 2026-09-06, client's own list for the My Meal Plan
      // "Sprouts" section) — no `vegetableType`: none of the existing
      // storefront rail groups (leafy/root/tuber/bulb/stem/fruit/pod/flower/
      // seed) fit a sprouted legume cleanly, and adding a new rail group is
      // a separate storefront decision this list doesn't need to make.
      // Prices are this session's own estimate for common Maharashtra
      // small-vendor rates, not the client's — check/adjust in admin before
      // these go live for real customers.
      {
        sku: 'VEG-SPROUT-MOONG',
        en: 'Moong Sprouts',
        mr: 'मूग स्प्राऊट्स',
        hi: 'मूंग स्प्राउट्स',
        unitType: UnitType.G,
        tags: ['protein', 'sprouts', 'high-fiber'],
        aliases: ['moong sprouts', 'mug sprouts', 'मूग स्प्राऊट्स', 'मूंग स्प्राउट्स'],
        variants: pack('200 g', 200, UnitType.G, 25, 28),
      },
      {
        sku: 'VEG-SPROUT-MATKI',
        en: 'Matki Sprouts',
        mr: 'मटकी स्प्राऊट्स',
        hi: 'मटकी स्प्राउट्स',
        unitType: UnitType.G,
        tags: ['protein', 'sprouts', 'high-fiber'],
        aliases: ['matki sprouts', 'moth bean sprouts', 'मटकी स्प्राऊट्स'],
        variants: pack('200 g', 200, UnitType.G, 25, 28),
      },
      {
        sku: 'VEG-SPROUT-CHANA',
        en: 'Chickpea Sprouts',
        mr: 'हरभरा स्प्राऊट्स',
        hi: 'चना स्प्राउट्स',
        unitType: UnitType.G,
        tags: ['protein', 'sprouts', 'high-fiber'],
        aliases: ['chana sprouts', 'harbhara sprouts', 'chickpea sprouts', 'हरभरा स्प्राऊट्स'],
        variants: pack('200 g', 200, UnitType.G, 30, 34),
      },
      {
        sku: 'VEG-SPROUT-COWPEA',
        en: 'Cowpea Sprouts',
        mr: 'चवळी स्प्राऊट्स',
        hi: 'चवली स्प्राउट्स',
        unitType: UnitType.G,
        tags: ['protein', 'sprouts', 'high-fiber'],
        aliases: ['chawli sprouts', 'cowpea sprouts', 'lobia sprouts', 'चवळी स्प्राऊट्स'],
        variants: pack('200 g', 200, UnitType.G, 30, 34),
      },
      {
        sku: 'VEG-SPROUT-MASOOR',
        en: 'Masoor Sprouts',
        mr: 'मसूर स्प्राऊट्स',
        hi: 'मसूर स्प्राउट्स',
        unitType: UnitType.G,
        tags: ['protein', 'sprouts', 'iron'],
        aliases: ['masoor sprouts', 'lentil sprouts', 'मसूर स्प्राऊट्स'],
        variants: pack('200 g', 200, UnitType.G, 35, 39),
      },
      {
        sku: 'VEG-SPROUT-ALFALFA',
        en: 'Alfalfa Sprouts',
        mr: 'अल्फाल्फा स्प्राऊट्स',
        hi: 'अल्फाल्फा स्प्राउट्स',
        unitType: UnitType.G,
        tags: ['protein', 'sprouts', 'low-calorie'],
        aliases: ['alfalfa sprouts', 'अल्फाल्फा स्प्राऊट्स'],
        variants: pack('200 g', 200, UnitType.G, 60, 66),
      },
      {
        sku: 'VEG-SPROUT-SOYBEAN',
        en: 'Soybean Sprouts',
        mr: 'सोयाबीन स्प्राऊट्स',
        hi: 'सोयाबीन स्प्राउट्स',
        unitType: UnitType.G,
        tags: ['protein', 'sprouts', 'high-fiber'],
        aliases: ['soybean sprouts', 'soya sprouts', 'सोयाबीन स्प्राऊट्स'],
        variants: pack('200 g', 200, UnitType.G, 35, 39),
      },
      {
        sku: 'VEG-SPROUT-MOONG-MATKI-MIX',
        en: 'Moong-Matki Mix Sprouts',
        mr: 'मूग + मटकी मिक्स स्प्राऊट्स',
        hi: 'मूंग-मटकी मिक्स स्प्राउट्स',
        unitType: UnitType.G,
        tags: ['protein', 'sprouts', 'high-fiber'],
        aliases: ['moong matki mix sprouts', 'mixed sprouts', 'मूग मटकी मिक्स स्प्राऊट्स'],
        variants: pack('200 g', 200, UnitType.G, 28, 32),
      },
      {
        sku: 'VEG-SPROUT-MIXED-DAL',
        en: 'Mixed Dal Sprouts',
        mr: 'मिक्स डाळ स्प्राऊट्स',
        hi: 'मिक्स दाल स्प्राउट्स',
        unitType: UnitType.G,
        tags: ['protein', 'sprouts', 'high-fiber'],
        aliases: ['mixed dal sprouts', 'मिक्स डाळ स्प्राऊट्स'],
        variants: pack('200 g', 200, UnitType.G, 32, 36),
      },
      {
        sku: 'VEG-SPROUT-BLACK-CHANA',
        en: 'Black Chickpea Sprouts',
        mr: 'काळा हरभरा स्प्राऊट्स',
        hi: 'काला चना स्प्राउट्स',
        unitType: UnitType.G,
        tags: ['protein', 'sprouts', 'iron'],
        aliases: ['black chana sprouts', 'kala chana sprouts', 'काळा हरभरा स्प्राऊट्स'],
        variants: pack('200 g', 200, UnitType.G, 32, 36),
      },
      {
        sku: 'VEG-SPROUT-GREEN-PEA',
        en: 'Green Pea Sprouts',
        mr: 'हिरवा वाटाणा स्प्राऊट्स',
        hi: 'हरा मटर स्प्राउट्स',
        unitType: UnitType.G,
        tags: ['protein', 'sprouts', 'high-fiber'],
        aliases: ['green pea sprouts', 'vatana sprouts', 'हिरवा वाटाणा स्प्राऊट्स'],
        variants: pack('200 g', 200, UnitType.G, 30, 34),
      },
    ],
  },
  {
    ...
    products: [
      ...
      // Client-requested sub-groups (session 2026-08-25): Citrus, Seasonal,
      // Exotic and Dry Fruits — the six products above only covered Citrus
      // and Seasonal, so the rest of this list exists to give Exotic and
      ...
      // by `scripts/fetch-product-images.mjs` (session 2026-08-26).
      {
        ...
        vegetableType: 'citrus',
        tags: ['vitamin-c', 'hydrating'],
        aliases: ['santra', 'orange', 'संतरा'],
        variants: weightLadder(90, 25),
      },
      {
        sku: 'FRT-MANGO',
        en: 'Mango',
        ...
        unitType: UnitType.G,
        vegetableType: 'seasonal',
        tags: ['seasonal', 'vitamin-a'],
        aliases: ['amba', 'aam', 'mango', 'आम'],
        variants: weightLadder(160, 20),
      },
      {
        sku: 'FRT-WATERMELON',
        en: 'Watermelon',
        ...
        aliases: ['kalingad', 'tarbuj', 'watermelon', 'तरबूज़'],
        variants: weightLadder(35, 20),
      },
      {
        sku: 'FRT-JAMUN',
        en: 'Jamun (Java Plum)',
        ...
        unitType: UnitType.G,
        vegetableType: 'seasonal',
        tags: ['seasonal', 'antioxidant'],
        aliases: ['jambhul', 'jamun', 'java plum', 'जामुन'],
        variants: weightLadder(180, 15),
      },
      {
        sku: 'FRT-KIWI',
        en: 'Kiwi',
        ...
        hi: 'कीवी',
        unitType: UnitType.PIECE,
        vegetableType: 'exotic',
        tags: ['exotic', 'vitamin-c'],
        aliases: ['kiwi', 'कीवी'],
        variants: [
          { label: '4 नग', quantity: 4, unit: UnitType.PIECE, price: 89, mrp: 100, stock: 20, isDefault: true },
        ],
      },
      {
        sku: 'FRT-DRAGONFRUIT',
        ...
        aliases: ['dragon fruit', 'ड्रॅगन फ्रूट'],
        variants: [
          { label: '1 नग', quantity: 1, unit: UnitType.PIECE, price: 99, mrp: 115, stock: 15, isDefault: true },
        ],
      },
      {
        sku: 'FRT-AVOCADO',
        ...
        unitType: UnitType.PIECE,
        vegetableType: 'exotic',
        tags: ['exotic', 'healthy-fat'],
        aliases: ['avocado', 'एवोकाडो'],
        variants: [
          { label: '1 नग', quantity: 1, unit: UnitType.PIECE, price: 79, mrp: 92, stock: 15, isDefault: true },
        ],
      },
      {
        sku: 'FRT-BLUEBERRY',
        ...
        vegetableType: 'exotic',
        tags: ['exotic', 'antioxidant'],
        aliases: ['blueberry', 'ब्लूबेरी'],
        variants: pack('125 g', 125, UnitType.G, 199, 230, 15),
      },
      {
        sku: 'FRT-ALMOND',
        en: 'Almonds',
        ...
        hi: 'बादाम',
        unitType: UnitType.G,
        vegetableType: 'dryfruits',
        mealPlanEligible: false,
        tags: ['dry-fruit', 'protein', 'healthy-fat'],
        aliases: ['badam', 'almond', 'बादाम'],
        variants: pack('250 g', 250, UnitType.G, 210, 235, 25),
      },
      {
        sku: 'FRT-CASHEW',
        en: 'Cashews',
        ...
        mealPlanEligible: false,
        tags: ['dry-fruit', 'protein', 'healthy-fat'],
        aliases: ['kaju', 'cashew', 'काजू'],
        variants: pack('250 g', 250, UnitType.G, 240, 270, 25),
      },
      {
        sku: 'FRT-WALNUT',
        en: 'Walnuts',
        ...
        vegetableType: 'dryfruits',
        mealPlanEligible: false,
        tags: ['dry-fruit', 'omega-3', 'healthy-fat'],
        aliases: ['akhrot', 'walnut', 'अखरोट'],
        variants: pack('250 g', 250, UnitType.G, 260, 290, 20),
      },
      {
        sku: 'FRT-RAISINS',
        en: 'Raisins',
        ...
        mealPlanEligible: false,
        tags: ['dry-fruit', 'iron'],
        aliases: ['manuka', 'kishmish', 'raisins', 'किशमिश'],
        variants: pack('250 g', 250, UnitType.G, 65, 78, 30),
      },
    ],
  },
  {
    ...
    products: [
      ...
      // Client-requested sub-groups (session 2026-08-26): Milk & Buttermilk,
      // Curd & Yogurt, Paneer & Cheese, Ghee & Butter — the four products
      // above only covered one kind each, so these exist to give every
      // group more than a single item. Prices are placeholders in the same
      // style as the rest of this seed file.
      {
        sku: 'DRY-BUTTERMILK-500',
        en: 'Buttermilk',
        mr: 'ताक',
        hi: 'छाछ',
        unitType: UnitType.ML,
        vegetableType: 'milk',
        tags: ['dairy', 'probiotic', 'allergen:milk'],
        aliases: ['taak', 'chaas', 'buttermilk', 'ताक'],
        variants: pack('500 ml', 500, UnitType.ML, 18, 22, 40),
      },
      {
        sku: 'DRY-YOGURT-100',
        en: 'Flavoured Yogurt',
        ...
        vegetableType: 'curd',
        tags: ['dairy', 'probiotic', 'allergen:milk'],
        aliases: ['yogurt', 'flavoured curd', 'योगर्ट'],
        variants: pack('100 g', 100, UnitType.G, 45, 52, 25),
      },
      {
        sku: 'DRY-CHEESESLICE-200',
        en: 'Cheese Slices',
        mr: 'चीज स्लाइस',
        hi: 'चीज़ स्लाइस',
        unitType: UnitType.G,
        vegetableType: 'paneer',
        tags: ['dairy', 'protein', 'allergen:milk'],
        aliases: ['cheese slice', 'चीज स्लाइस'],
        variants: pack('200 g', 200, UnitType.G, 120, 135, 20),
      },
      {
        sku: 'DRY-CHEESECUBE-200',
        en: 'Cheese Cubes',
        mr: 'चीज क्यूब्स',
        hi: 'चीज़ क्यूब्स',
        unitType: UnitType.G,
        vegetableType: 'paneer',
        tags: ['dairy', 'protein', 'allergen:milk'],
        aliases: ['cheese cubes', 'processed cheese', 'चीज क्यूब्स'],
        variants: pack('200 g', 200, UnitType.G, 140, 155, 20),
      },
      {
        sku: 'DRY-BUTTER-100',
        en: 'Butter',
        ...
        vegetableType: 'ghee',
        tags: ['dairy', 'fat', 'allergen:milk'],
        aliases: ['loni', 'makhan', 'butter', 'लोणी'],
        variants: pack('100 g', 100, UnitType.G, 55, 62, 25),
      },
    ],
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        hi: 'मारी बिस्कुट',
        unitType: UnitType.G,
        vegetableType: 'biscuits',
        tags: ['biscuit', 'allergen:gluten', 'allergen:milk'],
        aliases: ['marie', 'biscuit', 'बिस्किट'],
        variants: pack('250 g', 250, UnitType.G, 40, 45, 40),
      },
      // Client-requested sub-groups (session 2026-08-29): Bread & Buns,
      // Biscuits & Cookies, Cakes & Rusk — the three products above only
      // covered two of the three groups and left "bread" with just two
      // items, so these exist to give every group real breadth, same
      // reasoning as the Dairy and Fruits sub-groupings before it.
      {
        sku: 'BKY-BREAD-WHITE-400',
        en: 'White Bread',
        mr: 'पांढरा ब्रेड',
        hi: 'सफ़ेद ब्रेड',
        unitType: UnitType.G,
        vegetableType: 'bread',
        tags: ['bakery', 'breakfast', 'allergen:gluten'],
        aliases: ['white bread', 'sada bread', 'पांढरा ब्रेड'],
        variants: pack('400 g', 400, UnitType.G, 42, 48, 25),
      },
      {
        sku: 'BKY-BUN-BURGER-4',
        en: 'Burger Buns',
        mr: 'बर्गर बन',
        hi: 'बर्गर बन',
        unitType: UnitType.PIECE,
        ...
        aliases: ['burger bun', 'bun', 'बर्गर बन'],
        variants: pack('4 नग', 4, UnitType.PIECE, 35, 40, 25),
      },
      {
        sku: 'BKY-CREAMBISCUIT-150',
        en: 'Cream Biscuits',
        mr: 'क्रीम बिस्किटे',
        hi: 'क्रीम बिस्कुट',
        unitType: UnitType.G,
        vegetableType: 'biscuits',
        tags: ['biscuit', 'allergen:gluten', 'allergen:milk'],
        aliases: ['cream biscuit', 'बिस्किट'],
        variants: pack('150 g', 150, UnitType.G, 30, 35, 30),
      },
      {
        sku: 'BKY-GLUCOSE-200',
        en: 'Glucose Biscuits',
        ...
        unitType: UnitType.G,
        vegetableType: 'biscuits',
        tags: ['biscuit', 'allergen:gluten'],
        aliases: ['glucose biscuit', 'parle-g', 'ग्लुकोज बिस्किट'],
        variants: pack('200 g', 200, UnitType.G, 25, 28, 35),
      },
      {
        sku: 'BKY-RUSK-200',
        en: 'Elaichi Rusk',
        ...
        vegetableType: 'cakes',
        tags: ['bakery', 'breakfast', 'allergen:gluten'],
        aliases: ['rusk', 'toast', 'रस्क'],
        variants: pack('200 g', 200, UnitType.G, 55, 62, 20),
      },
      {
        sku: 'BKY-CAKE-300',
        en: 'Butter Cake',
        ...
        unitType: UnitType.G,
        vegetableType: 'cakes',
        tags: ['bakery', 'dessert', 'allergen:gluten', 'allergen:milk'],
        aliases: ['cake', 'butter cake', 'केक'],
        variants: pack('300 g', 300, UnitType.G, 90, 100, 15),
      },
    ],
  },
  {
